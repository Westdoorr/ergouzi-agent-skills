...
function isNonPublicIp(address) {
  ...
  return (
    value === 0n ||
    value === 1n ||
    (value >= 0x20010db8000000000000000000000000n &&
      value <= 0x20010db8ffffffffffffffffffffffffn) ||
    (value >= 0xfc000000000000000000000000000000n &&
      value <= 0xfdffffffffffffffffffffffffffffffn) ||
    (value >= 0xfe800000000000000000000000000000n &&
      value <= 0xfebfffffffffffffffffffffffffffffn) ||
    value >= 0xff000000000000000000000000000000n
  );
}
